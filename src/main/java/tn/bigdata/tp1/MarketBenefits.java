...
public class MarketBenefits {
    public static void main(String[] args) throws Exception {
        ...
        job.setCombinerClass(FloatSumReducer.class); // Converted to Float
        job.setReducerClass(FloatSumReducer.class); // Converted to Float
        job.setOutputKeyClass(Text.class);
        job.setOutputValueClass(FloatWritable.class); // Converted to Float
